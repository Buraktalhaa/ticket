...
export async function createTicket(req: Request, res: Response) {
    try {
        ...
        if(!categoryName || !title || !location || !city || !description || !dateTime || !stock || !price || !pointRate || !pointExpiresAt || !discount){
        ...
        handleError(res, 'An error occurred while creating ticket', 500);
        return
    }
}